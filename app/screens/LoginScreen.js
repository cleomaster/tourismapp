    ...
    return (
      <ImageBackground source={require("../assets/cool-background.png")} style={styles.container}>
        <View style={styles.form}>
            <AppText size={35} style={styles.formText}>Login</AppText>
            ...
            <AppButton
            onPress={() => {
           loginUser(email, password, navigation, { longitude, latitude})
            }}
             title="Login" bgColor={colors.white} txtColor="black" />
            </View>
            <AppText size={20} style={styles.textP}>OR</AppText>
            <TouchableOpacity onPress={() =>
            navigation.navigate("RegisterScreen", {longitude, latitude})
            }>
            <AppText size={20} style={styles.textButton}>Register</AppText>
            </TouchableOpacity>
        </View>
      </ImageBackground>
    );
